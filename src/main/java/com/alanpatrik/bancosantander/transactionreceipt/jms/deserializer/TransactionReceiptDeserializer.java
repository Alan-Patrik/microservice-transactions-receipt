package com.alanpatrik.bancosantander.transactionreceipt.jms.deserializer;
...
@Slf4j
public class TransactionReceiptDeserializer implements Deserializer<TransactionDTO> {
